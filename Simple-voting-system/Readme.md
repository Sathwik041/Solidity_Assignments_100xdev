Title: Simple Voting System Concepts: Arrays, loops, mappings, managing ownership.

Problem Statement: Create a Voting contract where a list of candidates can be voted for by users. The contract should:
